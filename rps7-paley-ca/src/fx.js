...
//
// cellGlow(i): a STABLE per-cell brightness factor in [0.6, 1.0]. Drawing each
...
//   flicker), and a cell keeps its slot as it changes element.
//
...
export function cellGlow(i) {
  ...
  return 0.6 + 0.4 * (((h >>> 0) & 0xffff) / 0xffff);
}
